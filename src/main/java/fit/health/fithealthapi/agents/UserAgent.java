...
public class UserAgent extends Agent {
    ...
    public void init(MealPlanService mealPlanService, User user, Set<RecipeType> recipeTypes) {
    ...
    private class RequestMealPlanBehaviour extends OneShotBehaviour {
        ...
        public void action() {
            ...
            request.setContent(user.getId()+";"+recipeTypes.toString());
    ...
    private class ReceiveMealPlanBehaviour extends CyclicBehaviour {
        ...
        public void action() {
            ...
            if (msg != null && msg.getPerformative() == ACLMessage.INFORM) {
                ...
                mealPlanService.createMealPlan(user.getUsername()+ "_AIGenerated_" + formattedDate, user, mealPlan);
                myAgent.doDelete();
            } else {
                block();
            }
